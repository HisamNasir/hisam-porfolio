            ...
            <div className="flex flex-col mb-10 lg:items-start items-center">
              ...
              <div className="flex-grow">
                ...
                <div className="grid grid-cols-3 border rounded-xl ">
                  <a  href="mailto:nowhere@mozilla.org"className="p-4 h-300 hover:bg-slate-100 rounded-xl">
                 
                  <Image  alt="" src={Gmail}/>
                  </a>
                  <a href="https://github.com/HisamNasir" className="p-4 h-300 hover:bg-slate-100 rounded-xl">
                  <Image alt="" src={Github}/>
                  </a>
                  <button className="p-4 h-300 hover:bg-slate-100 rounded-xl">

    ...
    <html lang="en">
      <body className={`${lato.variable}`}>
        <button
          ...
          type="button"
          className="absolute inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-amber-400 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        >
        ...
        >
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-100 dark:bg-gray-800">
            <div className="space-y-2 font-medium h-full grid-rows-5">
              <div>
                <Link
                  href="/"
